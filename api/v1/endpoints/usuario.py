...
from schemas.usuario_schema import UsuarioSchemaBase, UsuarioShemaCreate, UsuarioSchemaUp, UsuarioSchemaArtigos
...
# POST / SIGNUP -> CRIAR CONTA USUARIO
    ...
    async with db as session:
        try:
            ...
            raise HTTPException(status_code=status.HTTP_406_NOT_ACCEPTABLE,
                                detail='Já existe um usuario com este email cadastrado')
